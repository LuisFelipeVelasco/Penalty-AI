...
#evaluate_change look if the coordinates of the object change , in that case returns true
def evaluate_change(x1,x2,y1,y2,last_coordinates):
    last_x1, last_y1, last_x2, last_y2 = last_coordinates
    change_x = abs(x1 - last_x1) +  + abs(x2 - last_x2)
    change_y= abs(y1 - last_y1) +  + abs(y2 - last_y2) 
